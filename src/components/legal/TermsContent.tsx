export default function TermsContent() {
  return (
    <div className="pt-10 md:pt-14 pb-16 bg-white">
      <article className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 prose-custom">
        <a
          href="/"
          className="inline-flex items-center gap-2 text-sm text-brand-dark-green hover:text-brand-dark-orange transition-colors mb-8"
        >
